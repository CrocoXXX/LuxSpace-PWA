...
const subscribe = async () => {
    const key = "BMyOKztrvBHDQVtGpBsqBovvW8IBWjpNqAVu7G_Ujv8MVzDsPKhKBKOSiGdeYklRGGO3TvRTvtbOA9LMJyVzgVM"
                    ...
                    <div className="flex flex-stretch items-center">
                        ...
                        <div className="w-auto">
                            ...
                            >
                                ...
                                <li className="mx-3 py-6 md:py-0">
                                    <a href="/" className="text-black md:text-black hover:underline">Profile</a>
                                </li>
                            </ul>
                        </div>
                        <div className="w-auto">
